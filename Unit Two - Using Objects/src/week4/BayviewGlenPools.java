...
public class BayviewGlenPools {
    ...
    private static double getSurfaceArea(int length, int width, int shallowHeight, int shallowLength, int transition,
            int deepHeight) {
        double deepWall = deepHeight*width;
        ...
        double side = shallowHeight * shallowLength + deepHeight * deepLength + transitionBase * shallowHeight + (deepHeight - shallowHeight) * transitionBase * 0.5;        
    ...
    private static double getVolume(int length, int width, int shallowHeight, int shallowLength, int transition,
        ...
        double deepVolume = deepHeight*width*deepLength;
        double shallowVolume = width*shallowHeight*shallowLength;
