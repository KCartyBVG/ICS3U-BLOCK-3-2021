...
public class UnitTest {
    public static void main(String[] args) {
       ...
       // System.out.println("Computer Science", 3, 4);
       // System.out.println("Happy", 1, 2);
...
public static String removeChars(String str, int index, int n) {
    ...
    public static double sqrtSum(int number) {
        ...
        int n2 = number / 100 % 10; // ex 6384/100 = 63 %10 = 3
        int n3 = number / 10 % 10; // ex 6384/10 = 638 % 10 = 6
        int n4 = number % 10; // ex 6384 % 10 = 4

        int sum = n1 + n2 + n3 + n4;

        return Math.sqrt(sum); // if the class owns it its static
